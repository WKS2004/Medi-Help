...
@WebServlet(name = "DeleteReviewServlet", value = "/product/review/delete")
public class DeleteReviewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (loggedUser != null) {
            request.getRequestDispatcher("/products/deleteReview.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean updatedStatus = ReviewServices.removeReview(loggedUser.getUsername(), product.getProductName());
        if (updatedStatus) {
            response.sendRedirect(request.getContextPath() + "/products?deleteReview=true");
        }
        else {
            response.sendRedirect(request.getContextPath() + "/products?error=ReviewCouldNotBeDeleted");
        }
    }
}
