        ...
        <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
            <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                <div class="sm:max-w-lg">
                    <h3 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Looking for Medical Essentials?</h3>
                    <p class="mt-4 text-xl text-gray-500">We got you covered. Now you can find all your Medical Needs in one place.</p>
                </div>
                <div>
                    <div class="mt-10">
                                ...
                                <div class="flex items-center space-x-6 lg:space-x-8">
                                    <div class="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                        <div class="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                                            <img src="${pageContext.request.contextPath}/assets/products/home/product-1.jpg" alt="" class="size-full object-cover">
                                        </div>
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="${pageContext.request.contextPath}/assets/products/home/product-2.jpg" alt="" class="size-full object-cover">
                                        </div>
                                    </div>
                                    <div class="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="${pageContext.request.contextPath}/assets/products/home/product-3.jpg" alt="" class="size-full object-cover">
                                        </div>
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="${pageContext.request.contextPath}/assets/products/home/product-4.jpg" alt="" class="size-full object-cover">
                                        </div>
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="${pageContext.request.contextPath}/assets/products/home/product-1.jpg" alt="" class="size-full object-cover">
                                        </div>
                        ...
                        <a href="#products" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
                <!--
                  ...
                  Leaving: "transition-opacity ease-linear duration-300"
                    ...
                    To: "opacity-0"
                -->
                <div id="mobileFilterOverlay" class="fixed inset-0 bg-black/25 hidden" aria-hidden="true"></div>

                <div id="mobileFilterPanel" class="fixed inset-0 z-40 flex translate-x-full transition-transform duration-300 hidden">
                    <!--
                        ...
                        <form class="mt-4 border-t border-gray-200">
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    ...
                                    <button type="button" class="filter-toggle-button flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500" aria-controls="filter-section-mobile-0" aria-expanded="false" data-target="filter-section-mobile-0">
                                        <span class="font-medium text-gray-900">Color</span>
                                        <span class="ml-6 flex items-center">
                                                <!-- Expand icon, show/hide based on section open state. -->
                                                <svg id="icon-plus-filter-section-mobile-0" class="icon-plus size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                                                    <path d="M10.75 4.75a.75.75 0 0 0-1.5 0v4.5h-4.5a.75.75 0 0 0 0 1.5h4.5v4.5a.75.75 0 0 0 1.5 0v-4.5h4.5a.75.75 0 0 0 0-1.5h-4.5v-4.5Z"></path>
                                                </svg>
                                            <!-- Collapse icon, show/hide based on section open state. -->
                                                <svg id="icon-minus-filter-section-mobile-0" class="icon-minus hidden size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                    ...
                    <svg id="icon-minus-filter-section-mobile-1" class="icon-minus hidden size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                      <path fill-rule="evenodd" d="M4 10a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H4.75A.75.75 0 0 1 4 10Z" clip-rule="evenodd"></path>
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    <!-- Expand/collapse section button -->
                                    <button type="button" class="filter-toggle-button flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500" aria-controls="filter-section-mobile-2" aria-expanded="false" data-target="filter-section-mobile-2">
                                        <span class="font-medium text-gray-900">Size</span>
                                        <span class="ml-6 flex items-center">
                    <!-- Expand icon, show/hide based on section open state. -->
                    <svg id="icon-plus-filter-section-mobile-2" class="icon-plus size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                      <path d="M10.75 4.75a.75.75 0 0 0-1.5 0v4.5h-4.5a.75.75 0 0 0 0 1.5h4.5v4.5a.75.75 0 0 0 1.5 0v-4.5h4.5a.75.75 0 0 0 0-1.5h-4.5v-4.5Z"></path>
                    </svg>
                                            <!-- Collapse icon, show/hide based on section open state. -->
                    <svg id="icon-minus-filter-section-mobile-2" class="icon-minus hidden size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                      <path fill-rule="evenodd" d="M4 10a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H4.75A.75.75 0 0 1 4 10Z" clip-rule="evenodd"></path>
                    </svg>
                  </span>
                                    </button>
                ...
                <div class="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
                    ...
                    <div class="flex items-center">
                        <div class="relative inline-block text-left">
                            <div>
                                <button type="button" class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="sortButton" aria-expanded="false" aria-haspopup="true">
                                    Sort
                            ...
                            -->
                            <div id="sortDropdown" class="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none hidden transition ease-in-out duration-150" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                        ...
                        <button id="openMobileFilter" type="button" class="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <form class="hidden lg:block">
                            ...
                            <ul role="list" class="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900">
                                <li>
                                    <p class="text-xl">Popular Categories</p>
                                </li>
                                <li>
                                    <a href="#">Baby Care</a>
                                </li>
                            ...
                            <div class="border-b border-gray-200 py-6">
                                <h3 class="-my-3 flow-root">
                                    <!-- Expand/collapse section button -->
                                    <button type="button" class="filter-toggle-button flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false" data-target="filter-section-0">
                                        <span class="font-medium text-gray-900">Availability</span>
                                        <span class="ml-6 flex items-center">
                                                <!-- Expand icon, show/hide based on section open state. -->
                                                <svg id="icon-plus-filter-section-0" class="icon-plus size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                                                    <path d="M10.75 4.75a.75.75 0 0 0-1.5 0v4.5h-4.5a.75.75 0 0 0 0 1.5h4.5v4.5a.75.75 0 0 0 1.5 0v-4.5h4.5a.75.75 0 0 0 0-1.5h-4.5v-4.5Z"></path>
                                                </svg>
                                            <!-- Collapse icon, show/hide based on section open state. -->
                                                <svg id="icon-minus-filter-section-0" class="icon-minus hidden size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                                                    <path fill-rule="evenodd" d="M4 10a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H4.75A.75.75 0 0 1 4 10Z" clip-rule="evenodd"></path>
                                                </svg>
                                            </span>
                                    </button>
