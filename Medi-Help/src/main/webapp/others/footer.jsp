...
<div class="border-t border-gray-200 w-full">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                <a href="${pageContext.request.contextPath}"  class="flex justify-center lg:justify-start">
                    <img class="h-10 w-auto" src="${pageContext.request.contextPath}/assets/mainLogo/Medi-Help-Logo.png" alt="Medi Help">
                </a>

                <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 10k Customers in Sri Lanka.</p>
                ...
                <div class="flex mt-4 py-8 space-x-4 justify-center lg:justify-start sm:mt-0 ">
            ...
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Medi Help</h4>
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Baby Care</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Beauty Care</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Pet Care</a></li>
                    <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Vitamins</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left">
            ...
            <!--End Col-->
            <div class="lg:mx-auto text-left">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Newsletter</h4>
                <div class="flex flex-col items-center lg:items-start">
                    <input type="text" class="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 text-sm mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"  placeholder="Your Email"/>
    ...
    <%@include file="footer-onlyCopyright.jsp"%>
</div>